...
(also referred to as a "channel" in the documentation.)
     ...
     # naming conventions.    This distingishes them from Digital components
     # that perform the same function.    Since they often have different
     # capabilities, it seems okay to distinguish them with different names.
     #
...
if __name__ == "__main__":
    ...
    import time
    #
    # Use stublib from this repo so this stub will work
